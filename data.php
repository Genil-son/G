...
<br>
<form action="datasalva.php" method="POST">
...
<br>
<div class="div-input">
<input type="date" placeholder="Insira a data" required name="data">
</div>

<br>
<div class="div-input1">
<input type="text" placeholder="Insira o dia de semana" required name="dia">
</div>
