...
<head>
   ...
   <link rel="stylesheet" href="consultamar.css">
...
<div class="texto">
<span> <strong> Consultas Marcadas </strong> </span>
</div>
...
{
    $cod_marcacao = $registro['cod_marcacao'];
    $nome = $registro['nome'];
    ...
    <a href='deletemarc.php?cod_marcacao=$registro[cod_marcacao]'>
