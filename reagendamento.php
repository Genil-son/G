...
<head>
    ...
    <link rel="stylesheet" href="reagendament.css">
    <title>Marcação de consulta</title>
</head>
<body>


<form action="comprovativo1.php" method="POST">

<div class="icone">
<img src="img/saúde.jpg" class="pri-imagem">
<br>
<span class="span-icone">Reagendamento</span>
<br>
...
<br>
<li><a href="marcação.php" class="marcacao">Marcação</a></li>
<br>
<li class="reagendar">Reagendar</li>
<br>
